#!/bin/bash
# USB HID Attack Setup
# Configures Raspberry Pi as USB HID device
...
mkdir -p /sys/kernel/config/usb_gadget/hid_attack
cd /sys/kernel/config/usb_gadget/hid_attack
...
echo "USB HID Attack" > strings/0x409/product
...
echo "[+] Connect device to target computer"
